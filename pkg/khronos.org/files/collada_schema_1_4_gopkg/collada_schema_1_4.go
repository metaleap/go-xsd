...
type TdateTime xsdt.DateTime

//	Since TdateTime is just a simple String type, this merely sets the current value from the specified string.
func (me *TdateTime) SetFromString (s string) { (*xsdt.DateTime)(me).SetFromString(s) }

//	Since TdateTime is just a simple String type, this merely returns the current string value.
func (me TdateTime) String () string { return xsdt.DateTime(me).String() }

//	This convenience method just performs a simple type conversion to TdateTime's alias type xsdt.DateTime
func (me TdateTime) ToXsdtDateTime () xsdt.DateTime { return xsdt.DateTime(me) }
...
type Ttoken xsdt.Token

//	Since Ttoken is just a simple String type, this merely sets the current value from the specified string.
func (me *Ttoken) SetFromString (s string) { (*xsdt.Token)(me).SetFromString(s) }

//	Since Ttoken is just a simple String type, this merely returns the current string value.
func (me Ttoken) String () string { return xsdt.Token(me).String() }

//	This convenience method just performs a simple type conversion to Ttoken's alias type xsdt.Token
func (me Ttoken) ToXsdtToken () xsdt.Token { return xsdt.Token(me) }
...
func (me TListOfNames) Values () (list []TName) {
	...
	for i, s := range svals { list[i] = TName(s) }
	return
}
		
type TListOfTokens xsdt.String

//	Since TListOfTokens is just a simple String type, this merely sets the current value from the specified string.
func (me *TListOfTokens) SetFromString (s string) { (*xsdt.String)(me).SetFromString(s) }

//	Since TListOfTokens is just a simple String type, this merely returns the current string value.
func (me TListOfTokens) String () string { return xsdt.String(me).String() }

//	This convenience method just performs a simple type conversion to TListOfTokens's alias type xsdt.String
func (me TListOfTokens) ToXsdtString () xsdt.String { return xsdt.String(me) }

//	TListOfTokens defines a String containing a whitespace-separated list of Ttoken values. This Values() method creates and returns a slice of all elements in that list.
func (me TListOfTokens) Values () (list []Ttoken) {
	var svals = xsdt.ListValues(string(me))
	list = make([]Ttoken, len(svals))
	for i, s := range svals { list[i] = Ttoken(s) }
	return
}
...
type Tint2X2 TListOfInts

//	Since Tint2X2 is just a simple String type, this merely sets the current value from the specified string.
func (me *Tint2X2) SetFromString (s string) { (*TListOfInts)(me).SetFromString(s) }

//	Since Tint2X2 is just a simple String type, this merely returns the current string value.
func (me Tint2X2) String () string { return TListOfInts(me).String() }

//	This convenience method just performs a simple type conversion to Tint2X2's alias type TListOfInts
func (me Tint2X2) ToTListOfInts () TListOfInts { return TListOfInts(me) }

type Tint3X3 TListOfInts

//	Since Tint3X3 is just a simple String type, this merely sets the current value from the specified string.
func (me *Tint3X3) SetFromString (s string) { (*TListOfInts)(me).SetFromString(s) }

//	Since Tint3X3 is just a simple String type, this merely returns the current string value.
func (me Tint3X3) String () string { return TListOfInts(me).String() }

//	This convenience method just performs a simple type conversion to Tint3X3's alias type TListOfInts
func (me Tint3X3) ToTListOfInts () TListOfInts { return TListOfInts(me) }

type Tint4X4 TListOfInts

//	Since Tint4X4 is just a simple String type, this merely sets the current value from the specified string.
func (me *Tint4X4) SetFromString (s string) { (*TListOfInts)(me).SetFromString(s) }

//	Since Tint4X4 is just a simple String type, this merely returns the current string value.
func (me Tint4X4) String () string { return TListOfInts(me).String() }

//	This convenience method just performs a simple type conversion to Tint4X4's alias type TListOfInts
func (me Tint4X4) ToTListOfInts () TListOfInts { return TListOfInts(me) }
...
type TfxPipelineStageCommon xsdt.String

//	Since TfxPipelineStageCommon is just a simple String type, this merely sets the current value from the specified string.
func (me *TfxPipelineStageCommon) SetFromString (s string) { (*xsdt.String)(me).SetFromString(s) }

//	Since TfxPipelineStageCommon is just a simple String type, this merely returns the current string value.
func (me TfxPipelineStageCommon) String () string { return xsdt.String(me).String() }

//	This convenience method just performs a simple type conversion to TfxPipelineStageCommon's alias type xsdt.String
func (me TfxPipelineStageCommon) ToXsdtString () xsdt.String { return xsdt.String(me) }

//	Returns true if the value of this enumerated TfxPipelineStageCommon is "VERTEXPROGRAM".
func (me TfxPipelineStageCommon) IsVertexprogram () bool { return me == "VERTEXPROGRAM" }

//	Returns true if the value of this enumerated TfxPipelineStageCommon is "FRAGMENTPROGRAM".
func (me TfxPipelineStageCommon) IsFragmentprogram () bool { return me == "FRAGMENTPROGRAM" }

//	Returns true if the value of this enumerated TfxPipelineStageCommon is "VERTEXSHADER".
func (me TfxPipelineStageCommon) IsVertexshader () bool { return me == "VERTEXSHADER" }

//	Returns true if the value of this enumerated TfxPipelineStageCommon is "PIXELSHADER".
func (me TfxPipelineStageCommon) IsPixelshader () bool { return me == "PIXELSHADER" }
...
type TglesMaxTextureCoordsIndex xsdt.NonNegativeInteger

//	Since TglesMaxTextureCoordsIndex is a non-string scalar type (either boolean or numeric), sets the current value obtained from parsing the specified string.
func (me *TglesMaxTextureCoordsIndex) SetFromString (s string) { (*xsdt.NonNegativeInteger)(me).SetFromString(s) }

//	Returns a string representation of this TglesMaxTextureCoordsIndex's current non-string scalar value.
func (me TglesMaxTextureCoordsIndex) String () string { return xsdt.NonNegativeInteger(me).String() }

//	This convenience method just performs a simple type conversion to TglesMaxTextureCoordsIndex's alias type xsdt.NonNegativeInteger
func (me TglesMaxTextureCoordsIndex) ToXsdtNonNegativeInteger () xsdt.NonNegativeInteger { return xsdt.NonNegativeInteger(me) }

type TglesMaxTextureImageUnitsIndex xsdt.NonNegativeInteger

//	Since TglesMaxTextureImageUnitsIndex is a non-string scalar type (either boolean or numeric), sets the current value obtained from parsing the specified string.
func (me *TglesMaxTextureImageUnitsIndex) SetFromString (s string) { (*xsdt.NonNegativeInteger)(me).SetFromString(s) }

//	Returns a string representation of this TglesMaxTextureImageUnitsIndex's current non-string scalar value.
func (me TglesMaxTextureImageUnitsIndex) String () string { return xsdt.NonNegativeInteger(me).String() }

//	This convenience method just performs a simple type conversion to TglesMaxTextureImageUnitsIndex's alias type xsdt.NonNegativeInteger
func (me TglesMaxTextureImageUnitsIndex) ToXsdtNonNegativeInteger () xsdt.NonNegativeInteger { return xsdt.NonNegativeInteger(me) }
...
type TSpringType xsdt.Nmtoken

//	Since TSpringType is just a simple String type, this merely sets the current value from the specified string.
func (me *TSpringType) SetFromString (s string) { (*xsdt.Nmtoken)(me).SetFromString(s) }

//	Since TSpringType is just a simple String type, this merely returns the current string value.
func (me TSpringType) String () string { return xsdt.Nmtoken(me).String() }

//	This convenience method just performs a simple type conversion to TSpringType's alias type xsdt.Nmtoken
func (me TSpringType) ToXsdtNmtoken () xsdt.Nmtoken { return xsdt.Nmtoken(me) }

//	Returns true if the value of this enumerated TSpringType is "LINEAR".
func (me TSpringType) IsLinear () bool { return me == "LINEAR" }

//	Returns true if the value of this enumerated TSpringType is "ANGULAR".
func (me TSpringType) IsAngular () bool { return me == "ANGULAR" }

type TCommonProfileInput xsdt.Nmtoken

//	Since TCommonProfileInput is just a simple String type, this merely sets the current value from the specified string.
func (me *TCommonProfileInput) SetFromString (s string) { (*xsdt.Nmtoken)(me).SetFromString(s) }

//	Since TCommonProfileInput is just a simple String type, this merely returns the current string value.
func (me TCommonProfileInput) String () string { return xsdt.Nmtoken(me).String() }

//	This convenience method just performs a simple type conversion to TCommonProfileInput's alias type xsdt.Nmtoken
func (me TCommonProfileInput) ToXsdtNmtoken () xsdt.Nmtoken { return xsdt.Nmtoken(me) }

//	Returns true if the value of this enumerated TCommonProfileInput is "BINORMAL".
func (me TCommonProfileInput) IsBinormal () bool { return me == "BINORMAL" }

//	Returns true if the value of this enumerated TCommonProfileInput is "COLOR".
func (me TCommonProfileInput) IsColor () bool { return me == "COLOR" }

//	Returns true if the value of this enumerated TCommonProfileInput is "CONTINUITY".
func (me TCommonProfileInput) IsContinuity () bool { return me == "CONTINUITY" }

//	Returns true if the value of this enumerated TCommonProfileInput is "IMAGE".
func (me TCommonProfileInput) IsImage () bool { return me == "IMAGE" }

//	Returns true if the value of this enumerated TCommonProfileInput is "IN_TANGENT".
func (me TCommonProfileInput) IsInTangent () bool { return me == "IN_TANGENT" }

//	Returns true if the value of this enumerated TCommonProfileInput is "INPUT".
func (me TCommonProfileInput) IsInput () bool { return me == "INPUT" }

//	Returns true if the value of this enumerated TCommonProfileInput is "INTERPOLATION".
func (me TCommonProfileInput) IsInterpolation () bool { return me == "INTERPOLATION" }

//	Returns true if the value of this enumerated TCommonProfileInput is "INV_BIND_MATRIX".
func (me TCommonProfileInput) IsInvBindMatrix () bool { return me == "INV_BIND_MATRIX" }

//	Returns true if the value of this enumerated TCommonProfileInput is "JOINT".
func (me TCommonProfileInput) IsJoint () bool { return me == "JOINT" }

//	Returns true if the value of this enumerated TCommonProfileInput is "LINEAR_STEPS".
func (me TCommonProfileInput) IsLinearSteps () bool { return me == "LINEAR_STEPS" }

//	Returns true if the value of this enumerated TCommonProfileInput is "MORPH_TARGET".
func (me TCommonProfileInput) IsMorphTarget () bool { return me == "MORPH_TARGET" }

//	Returns true if the value of this enumerated TCommonProfileInput is "MORPH_WEIGHT".
func (me TCommonProfileInput) IsMorphWeight () bool { return me == "MORPH_WEIGHT" }

//	Returns true if the value of this enumerated TCommonProfileInput is "NORMAL".
func (me TCommonProfileInput) IsNormal () bool { return me == "NORMAL" }

//	Returns true if the value of this enumerated TCommonProfileInput is "OUTPUT".
func (me TCommonProfileInput) IsOutput () bool { return me == "OUTPUT" }

//	Returns true if the value of this enumerated TCommonProfileInput is "OUT_TANGENT".
func (me TCommonProfileInput) IsOutTangent () bool { return me == "OUT_TANGENT" }

//	Returns true if the value of this enumerated TCommonProfileInput is "POSITION".
func (me TCommonProfileInput) IsPosition () bool { return me == "POSITION" }

//	Returns true if the value of this enumerated TCommonProfileInput is "TANGENT".
func (me TCommonProfileInput) IsTangent () bool { return me == "TANGENT" }

//	Returns true if the value of this enumerated TCommonProfileInput is "TEXBINORMAL".
func (me TCommonProfileInput) IsTexbinormal () bool { return me == "TEXBINORMAL" }

//	Returns true if the value of this enumerated TCommonProfileInput is "TEXCOORD".
func (me TCommonProfileInput) IsTexcoord () bool { return me == "TEXCOORD" }

//	Returns true if the value of this enumerated TCommonProfileInput is "TEXTANGENT".
func (me TCommonProfileInput) IsTextangent () bool { return me == "TEXTANGENT" }

//	Returns true if the value of this enumerated TCommonProfileInput is "UV".
func (me TCommonProfileInput) IsUv () bool { return me == "UV" }

//	Returns true if the value of this enumerated TCommonProfileInput is "VERTEX".
func (me TCommonProfileInput) IsVertex () bool { return me == "VERTEX" }

//	Returns true if the value of this enumerated TCommonProfileInput is "WEIGHT".
func (me TCommonProfileInput) IsWeight () bool { return me == "WEIGHT" }

type TCommonProfileParam xsdt.Nmtoken

//	Since TCommonProfileParam is just a simple String type, this merely sets the current value from the specified string.
func (me *TCommonProfileParam) SetFromString (s string) { (*xsdt.Nmtoken)(me).SetFromString(s) }

//	Since TCommonProfileParam is just a simple String type, this merely returns the current string value.
func (me TCommonProfileParam) String () string { return xsdt.Nmtoken(me).String() }

//	This convenience method just performs a simple type conversion to TCommonProfileParam's alias type xsdt.Nmtoken
func (me TCommonProfileParam) ToXsdtNmtoken () xsdt.Nmtoken { return xsdt.Nmtoken(me) }

//	Returns true if the value of this enumerated TCommonProfileParam is "A".
func (me TCommonProfileParam) IsA () bool { return me == "A" }

//	Returns true if the value of this enumerated TCommonProfileParam is "ANGLE".
func (me TCommonProfileParam) IsAngle () bool { return me == "ANGLE" }

//	Returns true if the value of this enumerated TCommonProfileParam is "B".
func (me TCommonProfileParam) IsB () bool { return me == "B" }

//	Returns true if the value of this enumerated TCommonProfileParam is "DOUBLE_SIDED".
func (me TCommonProfileParam) IsDoubleSided () bool { return me == "DOUBLE_SIDED" }

//	Returns true if the value of this enumerated TCommonProfileParam is "G".
func (me TCommonProfileParam) IsG () bool { return me == "G" }

//	Returns true if the value of this enumerated TCommonProfileParam is "P".
func (me TCommonProfileParam) IsP () bool { return me == "P" }

//	Returns true if the value of this enumerated TCommonProfileParam is "Q".
func (me TCommonProfileParam) IsQ () bool { return me == "Q" }

//	Returns true if the value of this enumerated TCommonProfileParam is "R".
func (me TCommonProfileParam) IsR () bool { return me == "R" }

//	Returns true if the value of this enumerated TCommonProfileParam is "S".
func (me TCommonProfileParam) IsS () bool { return me == "S" }

//	Returns true if the value of this enumerated TCommonProfileParam is "T".
func (me TCommonProfileParam) IsT () bool { return me == "T" }

//	Returns true if the value of this enumerated TCommonProfileParam is "TIME".
func (me TCommonProfileParam) IsTime () bool { return me == "TIME" }

//	Returns true if the value of this enumerated TCommonProfileParam is "U".
func (me TCommonProfileParam) IsU () bool { return me == "U" }

//	Returns true if the value of this enumerated TCommonProfileParam is "V".
func (me TCommonProfileParam) IsV () bool { return me == "V" }

//	Returns true if the value of this enumerated TCommonProfileParam is "W".
func (me TCommonProfileParam) IsW () bool { return me == "W" }

//	Returns true if the value of this enumerated TCommonProfileParam is "X".
func (me TCommonProfileParam) IsX () bool { return me == "X" }

//	Returns true if the value of this enumerated TCommonProfileParam is "Y".
func (me TCommonProfileParam) IsY () bool { return me == "Y" }

//	Returns true if the value of this enumerated TCommonProfileParam is "Z".
func (me TCommonProfileParam) IsZ () bool { return me == "Z" }
...
//	The actual direction of the light is defined by the transform of the node where the light is
//	instantiated.
	Directionals []*TxsdLightSequenceTechniqueCommonChoiceDirectional `xml:"http://www.collada.org/2005/11/COLLADASchema directional"`
}
...
//	data. All coordinates are right-handed by definition. This element specifies which axis is
//	considered up. The default is the Y-axis. The up_axis element may appear zero or one time.
	UpAxises []TUpAxisType `xml:"http://www.collada.org/2005/11/COLLADASchema up_axis"`
}
